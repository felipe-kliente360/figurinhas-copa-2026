// Nota: Especiais usam prefixo "SPC" (não "ESP") para evitar conflito com a seleção Espanha (ESP)

export const TOTAL_STICKERS = 980 // 48 times × 19 + 68 especiais

export const ESPECIAIS = [
  // Apresentação (1–8)
  { id: 1,  nome: 'Logo FIFA World Cup 2026' },
  { id: 2,  nome: 'Troféu Jules Rimet' },
  { id: 3,  nome: 'Bola Oficial — Trionda' },
  { id: 4,  nome: 'Maple — Mascote Canadá 🦫' },
  { id: 5,  nome: 'Zayu — Mascote México 🐦' },
  { id: 6,  nome: 'Clutch — Mascote EUA 🐻' },
  { id: 7,  nome: 'Slogan Oficial' },
  { id: 8,  nome: 'Pôster Oficial' },
  // Estádios EUA (9–19)
  { id: 9,  nome: 'MetLife Stadium — Nova York/NJ' },
  { id: 10, nome: 'Rose Bowl — Los Angeles' },
  { id: 11, nome: 'SoFi Stadium — Los Angeles' },
  { id: 12, nome: 'AT&T Stadium — Dallas' },
  { id: 13, nome: 'NRG Stadium — Houston' },
  { id: 14, nome: "Levi's Stadium — San Francisco" },
  { id: 15, nome: 'Arrowhead Stadium — Kansas City' },
  { id: 16, nome: 'Empower Field — Denver' },
  { id: 17, nome: 'Lincoln Financial Field — Filadélfia' },
  { id: 18, nome: 'Gillette Stadium — Boston' },
  { id: 19, nome: 'Seattle — Lumen Field' },
  // Estádios México (20–22)
  { id: 20, nome: 'Estádio Azteca — Cidade do México' },
  { id: 21, nome: 'Estadio Akron — Guadalajara' },
  { id: 22, nome: 'Estadio BBVA — Monterrey' },
  // Estádios Canadá (23–24)
  { id: 23, nome: 'BC Place — Vancouver' },
  { id: 24, nome: 'BMO Field — Toronto' },
  // História das Copas (25–46)
  { id: 25, nome: 'Copa 1930 — Uruguai' },
  { id: 26, nome: 'Copa 1934 — Itália' },
  { id: 27, nome: 'Copa 1938 — França' },
  { id: 28, nome: 'Copa 1950 — Brasil' },
  { id: 29, nome: 'Copa 1954 — Suíça' },
  { id: 30, nome: 'Copa 1958 — Suécia' },
  { id: 31, nome: 'Copa 1962 — Chile' },
  { id: 32, nome: 'Copa 1966 — Inglaterra' },
  { id: 33, nome: 'Copa 1970 — México' },
  { id: 34, nome: 'Copa 1974 — Alemanha' },
  { id: 35, nome: 'Copa 1978 — Argentina' },
  { id: 36, nome: 'Copa 1982 — Espanha' },
  { id: 37, nome: 'Copa 1986 — México' },
  { id: 38, nome: 'Copa 1990 — Itália' },
  { id: 39, nome: 'Copa 1994 — EUA' },
  { id: 40, nome: 'Copa 1998 — França' },
  { id: 41, nome: 'Copa 2002 — Japão/Coreia' },
  { id: 42, nome: 'Copa 2006 — Alemanha' },
  { id: 43, nome: 'Copa 2010 — África do Sul' },
  { id: 44, nome: 'Copa 2014 — Brasil' },
  { id: 45, nome: 'Copa 2018 — Rússia' },
  { id: 46, nome: 'Copa 2022 — Catar' },
  { id: 47, nome: 'Recordes do Mundial' },
  { id: 48, nome: 'Maiores Artilheiros Históricos' },
  // Lendas (49–59)
  { id: 49, nome: 'Lendas — Pelé' },
  { id: 50, nome: 'Lendas — Maradona' },
  { id: 51, nome: 'Lendas — Ronaldo Fenômeno' },
  { id: 52, nome: 'Lendas — Zidane' },
  { id: 53, nome: 'Lendas — Ronaldinho' },
  { id: 54, nome: 'Lendas — Beckenbauer' },
  { id: 55, nome: 'Lendas — Cruyff' },
  { id: 56, nome: 'Lendas — Eusébio' },
  { id: 57, nome: 'Lendas — Di Stéfano' },
  { id: 58, nome: 'Lendas — Platini' },
  { id: 59, nome: 'Lendas — Romário' },
  // Copa 2026 (60–62)
  { id: 60, nome: 'Artilheiros Copa 2026' },
  { id: 61, nome: 'Seleções Anfitriãs' },
  { id: 62, nome: 'Mapa das Sedes' },
  // Holográficas / Raras (63–68)
  { id: 63, nome: '⭐ Extra Sticker — Messi' },
  { id: 64, nome: '⭐ Extra Sticker — Cristiano Ronaldo' },
  { id: 65, nome: '⭐ Extra Sticker — Vinícius Júnior' },
  { id: 66, nome: '⭐ Extra Sticker — Mbappé' },
  { id: 67, nome: '⭐ Extra Sticker — Lamine Yamal' },
  { id: 68, nome: '⭐ Extra Sticker — Erling Haaland' },
]
